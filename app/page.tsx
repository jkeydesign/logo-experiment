              ...
              <div style={{ maxWidth: 820, margin: '0 auto', display: 'grid', gap: 34, fontSize: 16, lineHeight: 1.85, color: '#1f2937' }}>
                <section style={{ display: 'grid', gap: 14 }}>
                  ...
                  <p>
                    ...
                    본 실험은 생성형 AI 기반 브랜드 로고 디자인 환경에서 전문 디자이너의 판단 과정을 살펴보기 위한 온라인 실험입니다. 생성형 AI 로고 제작 환경의 발전은 전문 디자이너의 역할을 단순 제작자에서 지시, 비교, 선별, 수정 방향을 판단하는 조율자 역할로 변화시키고 있습니다. 이에 본 연구는 전문 디자이너의 경험과 판단이 생성형 AI 정보 활용 과정에서 어떻게 작용하는지 이해하고, 전문 디자이너가 효율적으로 AI가 협력할 수 있는 전문 디자이너-AI 공동 판단 프레임워크를 모색하고자 합니다.
                  </p>
                  <p>
                    연구의 목적은 가상의 브랜드를 전문 디자이너가 AI 생성형 로고 시안을 비교·판단하는 과정에서 AI가 제시하는 여러 정보가 판단에 어떠한 영향을 미치는지 과정을 확인하는 데 있습니다.<br />
                    실험 참가자께서는 실제 실무에서 로고 후보 시안을 검토하듯이, 제시된 브랜드 맥락과 시각적 경험을 바탕으로 AI 로고 시안을 평가·판단해 주시면 됩니다. 본 실험에는 정답이나 미적 우열이나 AI 생성 성능을 평가 하지 않습니다. 참가자 본인의 전문적 판단에 따라 응답해 주시면 됩니다.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <ul style={{ display: 'grid', gap: 6, paddingLeft: 20 }}>
                    ...
                    <li>로고 디자인 또는 브랜드 아이덴티티 프로젝트 3건 이상 경험이 있는 전문 디자이너</li>
                  </ul>
                </section>
                ...
                <section>
                  ...
                  <ul style={{ display: 'grid', gap: 6, paddingLeft: 20 }}>
                    ...
                    <li>수집 자료는 AI 로고 시안에 대한 후보 유지, 제외, 변경, 최종 선택 과정과 간단한 설문 응답입니다.</li>
                    <li>제공되는 AI LOGO PRO 웹사이트의 AI 시안과 AI 추천, 평가, 순위 정보 등은 연구 목적에 맞게 개발 된 실제 AI로 구성된 조건입니다.</li>
                ...
                <section>
                  <p>
                    ...
                    참가자께서 제공해주신 판단 과정 자료는 전문 디자이너와 AI의 협력적 판단 구조를 이해하는 데 소중한 연구 자료로 활용됩니다.
                  </p>
                </section>
              ...
              <div style={{ fontSize: 16, color: '#333333', lineHeight: 1.75, marginBottom: 28, wordBreak: 'keep-all', textAlign: 'justify' }}>
                {activeBrief.code === 'OVBNE' ? (
                  <div style={{ textAlign: 'center' }}>
                    ...
                    <p>
                      브랜드 맥락 평가를 위해 브랜드 브리프를 자세히 여러번 읽고 기억하시면서 AI가 만든 로고를 판단해 주세요.
                    </p>
                  </div>
                ) : (
                  <p>
